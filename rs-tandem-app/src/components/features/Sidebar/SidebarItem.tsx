...
const SidebarItem = ({ image: Image, title, isOpen,onClick }: PropsSidebarItem) => {
  return (
    <div className="flex gap-4 items-center p-1 rounded-lg hover:bg-white/10 transition-colors cursor-pointer" onClick = {onClick}>
